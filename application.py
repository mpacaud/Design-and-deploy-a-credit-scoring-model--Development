...
# Tell the program the "application.py" file should be considered as a flask application.
...
@application.route('/api/predictions/<int:customer_id>') #{customer_id}
...
@application.route('/api/interpretations/<int:customer_id>/<int:cat_class>')
...
# NB: Display the root message at the end of the script when everything else happlicationened well until here.
@application.route('/')
def api_running ():
