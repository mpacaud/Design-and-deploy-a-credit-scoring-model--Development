...
def add_trend_feature(features, gr, feature_name, prefix, np=np):
...
#parallel_apply(gp, func, index_name='SK_ID_CURR', chunk_size=10000)
def parallel_apply(groups, func, index_name='Index', num_workers=0, chunk_size=100000):
    ...
    for index_chunk, groups_chunk in chunk_groups(groups, chunk_size):
        print('test02', num_workers)
        with mp.Pool(num_workers) as executor: #mp.pool.Pool(num_workers) as executor:
            print('test020')
